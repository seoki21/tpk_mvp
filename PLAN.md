...
- 언어 리소스 파일은 JSON 형식으로 `user-web/src/locales/` 하위에 언어별 분리
- 사용자가 선택한 언어는 localStorage에 저장하여 재방문 시 유지
- 사용자 웹에만 다국어 적용 (관리자 웹은 한국어 고정, vue-i18n 미사용)
...
>
> * [x] Vite + Vue.js 3 프로젝트 초기화 (admin-web 완료, user-web 미완)
> * [x] Tailwind CSS 설정 (admin-web 완료)
> * [x] 라우터 설정 (Vue Router 4, admin-web 완료)
