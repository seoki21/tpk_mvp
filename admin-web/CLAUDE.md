    ...
    * 3첨부의 기출문제를 분석하고 json으로 변환해줘
      ...
      2. 문제 유형
         ...
         * json key 값
           ...
           * 피드백내용은 한글로 정답이면 정답 피드백, 오답이면 오답 피드백
           * 피드백내용은 간결하고 읽기 좋게 30~40자 내외로 정리하고 한글의 경우 존대어를 사용한다.
      ...
      3. 기타 사항
         ...
         * 반드시 JSON 배열만 출력. 마크다운 코드블록으로 감싸지 말고 순수 JSON만 응답
